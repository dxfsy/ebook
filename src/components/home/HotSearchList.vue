<template>
  <transition name="hot-search-move">
    <scroll class="hot-search-wrapper"
            ...
            @onScroll="onScroll"
            ref="scroll">
      <HotSearch :label="$t('home.hotSearch')"
                  :btn="$t('home.change')"
                  :hotSearch="searchList.hotSearch"></HotSearch>
      <div class="line"></div>
      <HotSearch :label="$t('home.historySearch')"
                  :btn="$t('home.clear')"
                  :hotSearch="searchList.historySearch"></HotSearch>
    </scroll>
  </transition>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      onScroll(offsetY) {
        this.$store.dispatch('setHotSearchOffsetY',offsetY);
      },
      reset() {
